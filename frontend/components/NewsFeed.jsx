        ...
        return (
            <div className="newsfeed-container">
                ...
                <div className="newsfeed-list-container">
                    ...
                    {this.state.posts.sort().reverse().map(post => <ProfilePostIndexItem key={`newsfeed-post${post.id}`} timeline_owner_id={post.timeline_owner_id} author_id={post.author_id} post={post} />)}
                    </ul>
                </div>
            </div>
        )
