    ...
    render() {
        ...
        return (
            <div className="profile-sidebar-intro-details-container">
                <ul className={(user.location || user.current_city || user.hometown || user.workplace || user.education) ? (user.bio ? "profile-sidebar-intro-details-list profile-sidebar-intro-details-list-border-top" : "profile-sidebar-intro-details-list") : "hidden"}>
