...
class Profile extends React.Component {
    componentDidMount() {
        ...
        this.props.fetchFriendships(this.props.match.params.userId).fail(() => this.props.history.push("/"));
    }
        ...
        return (
            <div className="profile-container">
                ...
                <div className="profile-content-under-cover">
                    <ProfileSidebar user={this.props.user} currentUser={this.props.currentUser} friendships={this.props.entities.friendships} />
